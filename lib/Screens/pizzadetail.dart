      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                Image.asset('assets/pdetail1.png')
              ],
            ),
          ),
          SizedBox(height: 20.px,),
            ...
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text('Fijita Pizza', style: TextStyle(fontSize: 20.px,fontWeight: FontWeight.bold,color: Colors.black) ,),
                    Text('5.69\$',style: TextStyle(fontSize: 16.px,fontWeight: FontWeight.w400,color: Colors.black87),),
                  ],
                ),
              ),
              Container(
